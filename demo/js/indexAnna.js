 ...
 !(function t(e, i, r) {
...
})(
    {
                ...
                e.exports = {
                    ...
                    def: function (t, e, i) {
                        var r,
                            n,
                            s = $(t, e);
                        return s ? (s.v = i) : ((t._l = s = { i: (n = x(e, !0)), k: e, v: i, p: (r = t._l), n: void 0, r: !1 }), t._f || (t._f = s), r && (r.n = s), t[v]++, "F" !== n && (t._i[n] = s)), t;
                    },
                    getEntry: $,
        ...
        14: [
            ...
            { "./$.an-object": 4, "./$.array-methods": 8, "./$.for-of": 27, "./$.has": 30, "./$.hide": 31, "./$.is-object": 38, "./$.redefine-all": 61, "./$.strict-new": 70, "./$.uid": 83 },
        ],
        15: [
            function (t, e, i) {
                "use strict";
            ...
            { "./$.export": 22, "./$.fails": 24, "./$.for-of": 27, "./$.global": 29, "./$.is-object": 38, "./$.iter-detect": 43, "./$.redefine": 62, "./$.redefine-all": 61, "./$.set-to-string-tag": 67, "./$.strict-new": 70 },
        ],
        16: [
            function (t, e, i) {
            ...
            function (t, e, i) {
                var r = t("./$.global"),
                    ...
                    u = function (t, e, i) {
                        ...
                        m && (i = e);
                        for (c in i)
                            (h = !d && y && c in y), (f = (h ? y : i)[c]), (p = v && h ? a(f, r) : g && "function" == typeof f ? a(Function.call, f) : f), y && !h && o(y, c, f), x[c] != f && s(x, c, p), g && $[c] != f && ($[c] = f);
                    };
        ...
        27: [
            ...
            { "./$.an-object": 4, "./$.ctx": 17, "./$.is-array-iter": 35, "./$.iter-call": 40, "./$.to-length": 80, "./core.get-iterator-method": 88 },
        ],
        28: [
            function (t, e, i) {
                var r = t("./$.to-iobject"),
            ...
            function (t, e, i) {
                ...
                e.exports = function (t, e, i, v, y, x, $) {
                    ...
                    if (((r && !$) || (!p && !O && j[f]) || o(j, f, R), (l[e] = R), (l[P] = g), y))
                        if (((b = { values: S ? R : T(_), keys: x ? R : T(m), entries: S ? T("entries") : R }), $)) for (w in b) w in j || s(j, w, b[w]);
                        else n(n.P + n.F * (p || O), e, b);
                    return b;
                };
            },
            { "./$": 46, "./$.export": 22, "./$.has": 30, "./$.hide": 31, "./$.iter-create": 41, "./$.iterators": 45, "./$.library": 48, "./$.redefine": 62, "./$.set-to-string-tag": 67, "./$.wks": 84 },
        ],
        43: [
            function (t, e, i) {
                    ...
                    return function (e, i) {
                        ...
                        return l < 0 || l >= u
                            ? t
                                ? ""
                                : void 0
                            : ((s = a.charCodeAt(l)), s < 55296 || s > 56319 || l + 1 === u || (o = a.charCodeAt(l + 1)) < 56320 || o > 57343 ? (t ? a.charAt(l) : s) : t ? a.slice(l, l + 2) : ((s - 55296) << 10) + (o - 56320) + 65536);
                    };
                };
            },
        ...
        99: [
            function (t, e, i) {
                ...
                o ||
                    ...
                    s(s.S + s.F * !o, "Object", { getOwnPropertyDescriptor: n.getDesc, defineProperty: n.setDesc, defineProperties: M });
                    ...
                    "Array",
                    {
                        from: function (t) {
                            var e,
                                ...
                                g = 0,
                                v = u(h);
                            if ((_ && (m = r(m, d > 2 ? p[2] : void 0, 2)), void 0 == v || (f == Array && a(v)))) for (e = l(h.length), i = new f(e); e > g; g++) i[g] = _ ? m(h[g], g) : h[g];
                            else for (c = v.call(h), i = new f(); !(n = c.next()).done; g++) i[g] = _ ? o(c, m, [n.value, g], !0) : n.value;
                            return (i.length = g), i;
                        },
                    }
                );
            },
            { "./$.ctx": 17, "./$.export": 22, "./$.is-array-iter": 35, "./$.iter-call": 40, "./$.iter-detect": 43, "./$.to-length": 80, "./$.to-object": 81, "./core.get-iterator-method": 88 },
        ],
        105: [
            function (t, e, i) {
                "use strict";
            ...
            { "./$.add-to-unscopables": 3, "./$.iter-define": 42, "./$.iter-step": 44, "./$.iterators": 45, "./$.to-iobject": 79 },
        ],
        106: [
            function (t, e, i) {
                "use strict";
        ...
        128: [
            ...
            { "./$": 46, "./$.cof": 11, "./$.descriptors": 19, "./$.fails": 24, "./$.global": 29, "./$.has": 30, "./$.redefine": 62, "./$.string-trim": 75, "./$.to-primitive": 82 },
        ],
        129: [
            function (t, e, i) {
                var r = t("./$.export");
            ...
            function (t, e, i) {
                ...
                var r,
                    ...
                    S = (function () {
                        ...
                        var i = !1;
                        try {
                            if (((i = w && w.resolve && P()), m(e, w), (e.prototype = n.create(w.prototype, { constructor: { value: e } })), e.resolve(5).then(function () {}) instanceof e || (i = !1), i && t("./$.descriptors"))) {
                                var r = !1;
                                w.resolve(
                                    n.setDesc({}, "then", {
                                        get: function () {
                                    ...
                                    e &&
                                        setTimeout(function () {
                                            var e,
                                                i,
                                                n = t.p;
                                            C(n) && (b ? $.emit("unhandledRejection", r, n) : (e = o.onunhandledrejection) ? e({ promise: n, reason: r }) : (i = o.console) && i.error && i.error("Unhandled promise rejection", r)),
                                                (t.a = void 0);
                                        }, 1);
                            });
                        }
        ...
        154: [
            ...
            { "./$": 46, "./$.a-function": 2, "./$.an-object": 4, "./$.core": 16, "./$.export": 22, "./$.fails": 24, "./$.is-object": 38 },
        ],
        155: [
            function (t, e, i) {
                var r = t("./$"),
        ...
        167: [
            ...
            { "./$": 46, "./$.descriptors": 19, "./$.fails": 24, "./$.flags": 26, "./$.global": 29, "./$.is-regexp": 39, "./$.redefine": 62, "./$.set-species": 66, "./$.wks": 84 },
        ],
        168: [
            function (t, e, i) {
                var r = t("./$");
                t("./$.descriptors") && "g" != /./g.flags && r.setDesc(RegExp.prototype, "flags", { configurable: !0, get: t("./$.flags") });
            },
        ...
        183: [
            function (t, e, i) {
                ...
                r.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), function (t) {
                    ...
                    a(a.G + a.W, { Symbol: P }),
                    a(a.S, "Symbol", W),
                    a(a.S + a.F * !C, "Object", { create: L, defineProperty: N, defineProperties: z, getOwnPropertyDescriptor: X, getOwnPropertyNames: U, getOwnPropertySymbols: Y }),
        ...
        184: [
            ...
            { "./$": 46, "./$.collection": 15, "./$.collection-weak": 14, "./$.has": 30, "./$.is-object": 38, "./$.redefine": 62 },
        ],
        185: [
            function (t, e, i) {
                "use strict";
                            ...
                            function (t, e, i) {
                                ...
                                (s.version = "1.19.1"),
                                    ...
                                    (c.render = function (t, e, i) {
                                            ...
                                            (t >= p - 1e-7 && t >= 0
                                                ? ((this._totalTime = p),
                                                  ...
                                                  0 === g &&
                                                      ...
                                                      (v < 0 || (t <= 0 && t >= -1e-7) || (v === o && "isPause" !== this.data)) && v !== t && ((i = !0), v > o && (n = "onReverseComplete")),
                                                      (this._rawPrevTime = f = !e || t || v === t ? t : o)))
                                                : t < 1e-7
                                                ? ((this._totalTime = this._time = this._cycle = 0),
                                                  (this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0),
                                                  (0 !== m || (0 === g && v > 0)) && ((n = "onReverseComplete"), (r = this._reversed)),
                                                  t < 0 && ((this._active = !1), 0 === g && (this._initted || !this.vars.lazy || i) && (v >= 0 && (i = !0), (this._rawPrevTime = f = !e || t || v === t ? t : o))),
                                                  this._initted || (i = !0))
                                                : ((this._totalTime = this._time = t),
                                                  ...
                                                  this._easeType
                                                      ? ((u = this._time / g),
                                                        ...
                                                        1 === c ? (this.ratio = 1 - u) : 2 === c ? (this.ratio = u) : this._time / g < 0.5 ? (this.ratio = u / 2) : (this.ratio = 1 - u / 2))
                                        ...
                                        this._onUpdate && (t < 0 && this._startAt && this._startTime && this._startAt.render(t, e, i), e || ((this._totalTime !== m || n) && this._callback("onUpdate"))),
                                    ...
                                    (s.killChildTweensOf = function (t, e) {
                                        if (null != t) {
                                            var n,
                                                ...
                                                f,
                                                p = a.tweenLookup;
                                            if (("string" == typeof t && (t = i.selector(t) || t), l(t) && (t = r(t)), u(t))) for (h = t.length; --h > -1; ) s.killChildTweensOf(t[h], e);
                                            else {
                                                n = [];
                                ...
                                function (t, e, r) {
                                    ...
                                    return (
                                        ...
                                        (g.staggerTo = function (t, e, i, s, o, a, u, c) {
                                            var h,
                                                f,
                                                m = new n({ onComplete: a, onCompleteParams: u, callbackScope: c, smoothChildTiming: this.smoothChildTiming }),
                                                g = i.cycle;
                                            for ("string" == typeof t && (t = r.selector(t) || t), t = t || [], l(t) && (t = _(t)), s = s || 0, s < 0 && ((t = _(t)), t.reverse(), (s *= -1)), f = 0; f < t.length; f++)
                                                (h = p(i)),
                                        ...
                                        (n.exportRoot = function (t, e) {
                                            ...
                                            var i,
                                                ...
                                                o = new n(t),
                                                a = o._timeline;
                                            for (null == e && (e = !0), a._remove(o, !0), o._startTime = 0, o._rawPrevTime = o._time = o._totalTime = a._time, i = a._first; i; )
                                                (s = i._next), (e && i instanceof r && i.target === i.vars.onComplete) || o.add(i, i._startTime - i._delay), (i = s);
                                            return a.add(o, 0), o;
                                        }),
                                        ...
                                        (g._remove = function (t, i) {
                                            ...
                                            var r = this._last;
                                            return (
                                                r ? this._time > this.duration() && ((this._time = this._duration), (this._totalTime = this._totalDuration)) : (this._time = this._totalTime = this._duration = this._totalDuration = 0), this
                                            );
                                        }),
                                        ...
                                        (g._parseTimeOrLabel = function (e, i, r, n) {
                                            ...
                                            else if (n && (n instanceof Array || (n.push && u(n)))) for (s = n.length; --s > -1; ) n[s] instanceof t && n[s].timeline === this && this.remove(n[s]);
                                        ...
                                        (g.render = function (t, e, i) {
                                            ...
                                            if (t >= p - 1e-7 && t >= 0)
                                                ...
                                                if (
                                                    ...
                                                    (0 !== d || (0 === this._duration && this._rawPrevTime !== s && (this._rawPrevTime > 0 || (t < 0 && this._rawPrevTime >= 0)))) && ((a = "onReverseComplete"), (n = this._reversed)),
                                                    t < 0)
                                                )
                                                    (this._active = !1),
                                                        this._timeline.autoRemoveChildren && this._reversed ? ((l = n = !0), (a = "onReverseComplete")) : this._rawPrevTime >= 0 && this._first && (l = !0),
                                                        (this._rawPrevTime = t);
                                                else {
                                            ...
                                            if ((this._time !== d && this._first) || i || l || u) {
                                                if (
                                                    ...
                                                    for (r = this._first; r && ((o = r._next), f === this._time && (!this._paused || g)); )
                                                    ...
                                                    a &&
                                                        (this._gc ||
                                                            ...
                                                            ((0 === this._time || p >= this.totalDuration()) &&
                                                                (n && (c.length && h(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[a] && this._callback(a))));
                                            }
                                        }),
                                        ...
                                        (g.getChildren = function (t, e, i, n) {
                                            ...
                                            for (var s = [], o = this._first, a = 0; o; )
                                                o._startTime < n || (o instanceof r ? e !== !1 && (s[a++] = o) : (i !== !1 && (s[a++] = o), t !== !1 && ((s = s.concat(o.getChildren(!0, e, i))), (a = s.length)))), (o = o._next);
                                            return s;
                                        }),
                                    ...
                                    return (
                                        ...
                                        (h.render = function (t, e, i) {
                                            ...
                                            if (t >= d - 1e-7 && t >= 0)
                                                this._locked || ((this._totalTime = d), (this._cycle = this._repeat)),
                                                    this._reversed ||
                                                        ...
                                                        0 === this._duration && ((t <= 0 && t >= -1e-7) || x < 0 || x === s) && x !== t && this._first && ((c = !0), x > s && (u = "onReverseComplete"))),
                                                    (this._rawPrevTime = this._duration || !e || t || this._rawPrevTime === t ? t : s),
                                                ...
                                                if (
                                                    ...
                                                    (this._time = 0),
                                                    (0 !== _ || (0 === m && x !== s && (x > 0 || (t < 0 && x >= 0)) && !this._locked)) && ((u = "onReverseComplete"), (n = this._reversed)),
                                                    t < 0)
                                                )
                                                    (this._active = !1), this._timeline.autoRemoveChildren && this._reversed ? ((c = n = !0), (u = "onReverseComplete")) : x >= 0 && this._first && (c = !0), (this._rawPrevTime = t);
                                                else {
                                                    if (((this._rawPrevTime = m || !e || t || this._rawPrevTime === t ? t : s), 0 === t && n)) for (r = this._first; r && 0 === r._startTime; ) r._duration || (n = !1), (r = r._next);
                                            ...
                                            if (
                                                ...
                                                for (r = this._first; r && ((o = r._next), p === this._time && (!this._paused || $)); )
                                                ...
                                                u &&
                                                    (this._locked ||
                                                        ...
                                                        ((0 === this._time || d >= this.totalDuration()) &&
                                                            (n && (a.length && l(), this._timeline.autoRemoveChildren && this._enabled(!1, !1), (this._active = !1)), !e && this.vars[u] && this._callback(u))));
                                        }),
                                        ...
                                        (h.totalDuration = function (e) {
                                            return arguments.length
                                                ? this._repeat !== -1 && e
                                                    ...
                                                    : this
                                                : (this._dirty && (t.prototype.totalDuration.call(this), (this._totalDuration = this._repeat === -1 ? 999999999999 : this._duration * (this._repeat + 1) + this._repeatDelay * this._repeat)),
                                                  this._totalDuration);
                                        }),
                                        (h.time = function (t, e) {
                                            return arguments.length
                                ...
                                var t = 180 / Math.PI,
                                    ...
                                    c = function (t, i, s, o, a) {
                                        ...
                                        for (l = 0; l < b; l++)
                                            (p = t[w]),
                                                ...
                                                (T = m);
                                        (p = t[w]), (p.b = T), (p.c = T + 0.4 * (p.d - T)), (p.da = p.d - p.a), (p.ca = p.c - p.a), (p.ba = T - p.a), s && ((v = u(p.a, T, p.c, p.d)), t.splice(w, 1, v[0], v[1], v[2], v[3]));
                                    },
                                    h = function (t, i, n, s) {
                                        var o,
                                            l,
                                    ...
                                    p = function (t, e, i) {
                                        ...
                                        for (u = v.length; --u > -1; ) {
                                            ...
                                            for (h = p - _ + 1, p = 0, c = 0; c < h; c += _)
                                                (r = l[c]), (n = l[c + 1]), (s = l[c + 2]), (o = 2 === _ ? 0 : l[c + 3]), (l[p++] = d = 3 === _ ? new a(r, n, s, o) : new a(r, (2 * n + r) / 3, (2 * n + s) / 3, s));
                                            l.length = p;
                                        }
                                        return m;
                                    },
                                    d = function (t, e, i) {
                                        for (var r, n, s, o, a, l, u, c, h, f, p, d = 1 / i, m = t.length; --m > -1; )
                                            for (f = t[m], s = f.a, o = f.d - s, a = f.c - s, l = f.b - s, r = n = 0, c = 1; c <= i; c++)
                                                (u = d * c), (h = 1 - u), (r = n - (n = (u * u * o + 3 * h * (u * a + h * l)) * u)), (p = m * i + c - 1), (e[p] = (e[p] || 0) + r * r);
                                    },
                                    m = function (t, e) {
                                        e = e >> 0 || 6;
                                        var i,
                                    ...
                                    _ = i._gsDefine.plugin({
                                        ...
                                        init: function (t, e, i) {
                                            ...
                                            for (s = this._props.length; --s > -1; )
                                                (r = this._props[s]),
                                                    ...
                                                    a || (u[r] !== l[0][r] && (a = u));
                                            if (
                                                ((this._beziers = "cubic" !== e.type && "quadratic" !== e.type && "soft" !== e.type ? f(l, isNaN(e.curviness) ? 1 : e.curviness, !1, "thruBasic" === e.type, e.correlate, a) : p(l, e.type, u)),
                                        ...
                                        set: function (e) {
                                            ...
                                            for (r = 1 - a, n = this._props.length; --n > -1; )
                                                (s = this._props[n]), (o = this._beziers[s][i]), (l = (a * a * o.da + 3 * r * (a * o.ca + r * o.ba)) * a + o.a), this._mod[s] && (l = this._mod[s](l, d)), p[s] ? d[s](l) : (d[s] = l);
                                            if (this._autoRotate) {
                                                var _,
                                                    g,
                                                    v,
                                            ...
                                            e._registerComplexSpecialProp("bezier", {
                                                parser: function (t, e, s, o, a, l) {
                                                    ...
                                                    return (
                                                        ...
                                                        m.autoRotate && (o._transform || o._enableTransforms(!1), (h.autoRotate = o._target._gsTransform), (h.proxy.rotation = h.autoRotate.rotation || 0), o._overwriteProps.push("rotation")),
                            ...
                            i._gsDefine(
                                ...
                                function (t, e) {
                                    ...
                                    (c.constructor = a),
                                        ...
                                        (c = "px"),
                                        (a.suffixMap = { top: c, right: c, bottom: c, left: c, width: c, height: c, fontSize: c, padding: c, margin: c, perspective: c, lineHeight: "" });
                                    var h,
                                        f,
                                        p,
                                        d,
                                        ...
                                        W = (function () {
                                            var t = q.indexOf("Android"),
                                                e = X("a");
                                            return (
                                                (p = q.indexOf("Safari") !== -1 && q.indexOf("Chrome") === -1 && (t === -1 || parseFloat(q.substr(t + 8, 2)) > 3)),
                                        ...
                                        tt = (a.getStyle = function (t, e, i, r, n) {
                                            ...
                                            return W || "opacity" !== e
                                                ? (!r && t.style[e]
                                                      ? (s = t.style[e])
                                                      : (i = i || J(t))
                                                      ? (s = i[e] || i.getPropertyValue(e) || i.getPropertyValue(e.replace(j, "-$1").toLowerCase()))
                                        ...
                                        et = (G.convertToPixels = function (t, i, r, n, s) {
                                            ...
                                            if ((p && (r = -r), d && (r *= 100), "%" === n && i.indexOf("border") !== -1)) o = (r / 100) * (c ? t.clientWidth : t.clientHeight);
                                                ...
                                                if (((f.cssText = "border:0 solid red;position:" + tt(t, "position") + ";line-height:0;"), "%" !== n && h.appendChild && "v" !== n.charAt(0) && "rem" !== n))
                                                ...
                                                h.appendChild(U),
                                                    ...
                                                    h.removeChild(U),
                                                    c && "%" === n && a.cacheWidths !== !1 && ((l = h._gsCache = h._gsCache || {}), (l.time = u), (l.width = (o / r) * 100)),
                                        ...
                                        rt = function (t, e) {
                                            var i,
                                                ...
                                                s = {};
                                            if ((e = e || J(t, null)))
                                                if ((i = e.length)) for (; --i > -1; ) (n = e[i]), (n.indexOf("-transform") !== -1 && Rt !== n) || (s[n.replace(k, A)] = e.getPropertyValue(n));
                                                else for (i in e) (i.indexOf("Transform") !== -1 && kt !== i) || (s[i] = e[i]);
                                            else if ((e = t.currentStyle || t.style)) for (i in e) "string" == typeof i && void 0 === s[i] && (s[i.replace(k, A)] = e[i]);
                                            return (
                                                W || (s.opacity = V(t)),
                                                (r = Yt(t, e, !1)),
                                                ...
                                                (s.x = r.x),
                                                (s.y = r.y),
                                                Mt && ((s.z = r.z), (s.rotationX = r.rotationX), (s.rotationY = r.rotationY), (s.scaleZ = r.scaleZ)),
                                            ...
                                            for (o in i)
                                                "cssText" !== o &&
                                                    ...
                                                    (("number" != typeof s && "string" != typeof s) ||
                                                        ((l[o] = "auto" !== s || ("left" !== o && "top" !== o) ? (("" !== s && "auto" !== s && "none" !== s) || "string" != typeof e[o] || "" === e[o].replace(b, "") ? s : 0) : it(t, o)),
                                            ...
                                            return (
                                                ...
                                                null == t
                                                    ...
                                                    : ((n = 360),
                                                      ...
                                                      s.length &&
                                                          (r && (r[i] = e + o),
                                                          t.indexOf("short") !== -1 && ((o %= n), o !== o % (n / 2) && (o = o < 0 ? o + n : o - n)),
                                        ...
                                        dt = (a.parseColor = function (t, e) {
                                            ...
                                            return (
                                                e &&
                                                    ...
                                                    u === c
                                                        ? (o = a = 0)
                                                        : ((h = u - c), (a = l > 0.5 ? h / (2 - u - c) : h / (u + c)), (o = u === r ? (n - s) / h + (n < s ? 6 : 0) : u === n ? (s - r) / h + 2 : (r - n) / h + 4), (o *= 60)),
                                                    (i[0] = (o + 0.5) | 0),
                                                    (i[1] = (100 * a + 0.5) | 0),
                                                    (i[2] = (100 * l + 0.5) | 0)),
                                                i
                                    ...
                                    var gt = function (t, e, i, r) {
                                        ...
                                        bt = (a.parseComplex = function (t, e, i, r, n, s, o, l, u, c) {
                                            (i = i || s || ""),
                                                ...
                                                (r += ""),
                                                n && _t.test(r + i) && ((r = [i, r]), a.colorStringFilter(r), (i = r[0]), (r = r[1]));
                                            var f,
                                                p,
                                                d,
                                                m,
                                                ...
                                                M = h !== !1;
                                            for (
                                                (r.indexOf(",") === -1 && i.indexOf(",") === -1) || ((k = k.join(" ").replace(F, ", ").split(" ")), (R = R.join(" ").replace(F, ", ").split(" ")), (A = k.length)),
                                                ...
                                                if (((m = k[f]), (_ = R[f]), (w = parseFloat(m)), w || 0 === w)) o.appendXtra("", w, ut(_, w), _.replace(x, ""), M && _.indexOf("px") !== -1, !0);
                                                    ...
                                                    (O = _.indexOf(")") + 1),
                                                        ...
                                                        T && !W && 0 === _[3]
                                                            ? ((o["xs" + o.l] += o.l ? " transparent" : "transparent"), (o.e = o.e.split(R[f]).join("transparent")))
                                                            : (W || (T = !1),
                                                              j
                                                                  ? o
                                                              ...
                                                              T && ((m = m.length < 4 ? 1 : m[3]), o.appendXtra("", m, (_.length < 4 ? 1 : _[3]) - m, O, !1))),
                                                        (_t.lastIndex = 0);
                                                else if (($ = m.match(y))) {
                                                    if (((b = _.match(x)), !b || b.length !== $.length)) return o;
                                                    for (d = 0, p = 0; p < $.length; p++)
                                                        (S = $[p]), (P = m.indexOf(S, d)), o.appendXtra(m.substr(d, P - d), Number(S), ut(b[p], S), "", M && "px" === m.substr(P + S.length, 2), 0 === p), (d = P + S.length);
                                                    o["xs" + o.l] += m.substr(d);
                                            ...
                                            return (
                                                ...
                                                i || 0 === a || o.plugin
                                                    ? (o.l++,
                                                      ...
                                                      (o["xs" + o.l] = r || ""),
                                                      a > 0
                                                          ? ((o.data["xn" + a] = e + i), (o.rxp["xn" + a] = n), (o["xn" + a] = e), o.plugin || ((o.xfirst = new xt(o, "xn" + a, e, i, o.xfirst || o, 0, o.n, n, o.pr)), (o.xfirst.xs0 = 0)), o)
                                        ...
                                        (c.parseComplex = function (t, e, i, r, n, s) {
                                            ...
                                            if ((this.multi && (F.test(i) || F.test(e) ? ((a = e.replace(F, "|").split("|")), (l = i.replace(F, "|").split("|"))) : f && ((a = [e]), (l = [i]))), l)) {
                                                for (u = l.length > a.length ? l.length : a.length, o = 0; o < u; o++)
                                                    (e = a[o] = a[o] || this.dflt),
                                                        (i = l[o] = l[o] || this.dflt),
                                                        f && ((c = e.indexOf(f)), (h = i.indexOf(f)), c !== h && (h === -1 ? (a[o] = a[o].split(f).join("")) : c === -1 && (a[o] += " " + f)));
                                                (e = a.join(", ")), (i = l.join(", "));
                                            }
                                    ...
                                    var Ot,
                                        ...
                                        Nt = function (t, e, i, r, n, s) {
                                            ...
                                            $ && ((y = $.xOrigin), (x = $.yOrigin)),
                                                (!r || (o = r.split(" ")).length < 2) &&
                                                    ...
                                                    (e = lt(e).split(" ")),
                                                    (o = [
                                                        (e[0].indexOf("%") !== -1 ? (parseFloat(e[0]) / 100) * p.width : parseFloat(e[0])) + p.x,
                                                        (e[1].indexOf("%") !== -1 ? (parseFloat(e[1]) / 100) * p.height : parseFloat(e[1])) + p.y,
                                                    ])),
                                                ...
                                                r &&
                                                    ...
                                                    (g = b[5]),
                                                    (v = f * m - p * d),
                                                    v && ((l = c * (m / v) + h * (-d / v) + (d * g - m * _) / v), (u = c * (-p / v) + h * (f / v) - (f * g - p * _) / v), (c = i.xOrigin = o[0] = l), (h = i.yOrigin = o[1] = u))),
                                                $ &&
                                                    (s && ((i.xOffset = $.xOffset), (i.yOffset = $.yOffset), ($ = i)),
                                                    n || (n !== !1 && a.defaultSmoothOrigin !== !1) ? ((l = c - y), (u = h - x), ($.xOffset += l * b[0] + u * b[2] - l), ($.yOffset += l * b[1] + u * b[3] - u)) : ($.xOffset = $.yOffset = 0)),
                                                s || t.setAttribute("data-svg-origin", o.join(" "));
                                        },
                                        zt = function (t) {
                                            var e,
                                                i = X("svg", this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"),
                                                r = this.parentNode,
                                                n = this.nextSibling,
                                        ...
                                        Ut = function (t, e) {
                                            ...
                                            if (
                                                (kt
                                                    ? (r = tt(t, Rt, null, !0))
                                                    : t.currentStyle &&
                                                      ((r = t.currentStyle.filter.match(C)), (r = r && 4 === r.length ? [r[0].substr(4), Number(r[2].substr(4)), Number(r[1].substr(4)), r[3].substr(4), l.x || 0, l.y || 0].join(",") : "")),
                                                ...
                                                (l.svg || (t.getCTM && Bt(t))) &&
                                                    ...
                                                    i && n && (n.indexOf("matrix") !== -1 ? ((r = n), (i = 0)) : n.indexOf("translate") !== -1 && ((r = "matrix(1,0,0,1," + n.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",") + ")"), (i = 0)))),
                                                i)
                                            )
                                                return Xt;
                                            for (n = (r || "").match(y) || [], wt = n.length; --wt > -1; ) (s = Number(n[wt])), (n[wt] = (o = s - (s |= 0)) ? ((o * u + (o < 0 ? -0.5 : 0.5)) | 0) / u + s : s);
                                            ...
                                            if (((f.svg = !(!t.getCTM || !Bt(t))), f.svg && (Nt(t, tt(t, At, i, !1, "50% 50%") + "", f, t.getAttribute("data-svg-origin")), (Ot = a.useSVGTransformAttr || It)), (s = Ut(t)), s !== Xt)) {
                                                if (16 === s.length) {
                                                    var v,
                                                        ...
                                                        I = s[11],
                                                        z = Math.atan2(k, C);
                                                    f.zOrigin && ((E = -f.zOrigin), (D = A * E - s[12]), (F = M * E - s[13]), (E = C * E + f.zOrigin - s[14])),
                                                        (f.rotationX = z * N),
                                                        z &&
                                                            (($ = Math.cos(-z)),
                                                            (b = Math.sin(-z)),
                                                        ...
                                                        (z = Math.atan2(T, w)),
                                                        (f.rotation = z * N),
                                                        z && (($ = Math.cos(-z)), (b = Math.sin(-z)), (w = w * $ + O * b), (y = T * $ + j * b), (j = T * -b + j * $), (k = P * -b + k * $), (T = y)),
                                                        ...
                                                        (f.y = F),
                                                        (f.z = E),
                                                        f.svg && ((f.x -= f.xOrigin - (f.xOrigin * w - f.yOrigin * O)), (f.y -= f.yOrigin - (f.yOrigin * T - f.xOrigin * j)));
                                                    ...
                                                    (f.x = s[4] || 0),
                                                        ...
                                                        Math.abs(h) > 90 && Math.abs(h) < 270 && (p ? ((l *= -1), (h += c <= 0 ? 180 : -180), (c += c <= 0 ? 180 : -180)) : ((u *= -1), (h += h <= 0 ? 180 : -180))),
                                                        (f.scaleX = l),
                                                        (f.scaleY = u),
                                                        (f.rotation = c),
                                                        (f.skewX = h),
                                                        Mt && ((f.rotationX = f.rotationY = f.z = 0), (f.perspective = g), (f.scaleZ = 1)),
                                                        f.svg && ((f.x -= f.xOrigin - (f.xOrigin * B + f.yOrigin * U)), (f.y -= f.yOrigin - (f.xOrigin * X + f.yOrigin * Y)));
                                                }
                                                f.zOrigin = _;
                                        ...
                                        Gt = function (t) {
                                            ...
                                            if (f) {
                                                ...
                                                if (
                                                    (null != r.ox && ((p = (r.oxp ? m * r.ox * 0.01 : r.ox) - m / 2), (d = (r.oyp ? g * r.oy * 0.01 : r.oy) - g / 2), (x += p - (p * a + d * l)), ($ += d - (p * u + d * c))),
                                                    v ? ((p = m / 2), (d = g / 2), (y += ", Dx=" + (p - (p * a + d * l) + x) + ", Dy=" + (d - (p * u + d * c) + $) + ")")) : (y += ", sizingMethod='auto expand')"),
                                                    ...
                                                    (0 !== t && 1 !== t) ||
                                                        (1 === a &&
                                                            ...
                                                            0 === u &&
                                                            1 === c &&
                                                            ((v && y.indexOf("Dx=0, Dy=0") === -1) || (T.test(e) && 100 !== parseFloat(RegExp.$1)) || (e.indexOf(e.indexOf("Alpha")) === -1 && h.removeAttribute("filter")))),
                                                    !v)
                                                ) {
                                                    var b,
                                                        P,
                                        ...
                                        qt = (G.set3DTransformRatio = G.setTransformRatio = function (t) {
                                            ...
                                            if (
                                                ...
                                                return void (O || B || E
                                                    ? ((O *= I),
                                                      ...
                                                      (r = Math.sin(O - w) * -A),
                                                      (o = Math.cos(O - w) * A),
                                                      w && "simple" === P.skewType && ((e = Math.tan(w - L * I)), (e = Math.sqrt(1 + e * e)), (r *= e), (o *= e), L && ((e = Math.tan(L * I)), (e = Math.sqrt(1 + e * e)), (i *= e), (s *= e))),
                                                      E &&
                                                          ((C += P.xOrigin - (P.xOrigin * i + P.yOrigin * r) + P.xOffset),
                                                          (D += P.yOrigin - (P.xOrigin * s + P.yOrigin * o) + P.yOffset),
                                                          Ot && (P.xPercent || P.yPercent) && ((_ = this.t.getBBox()), (C += 0.01 * P.xPercent * _.width), (D += 0.01 * P.yPercent * _.height)),
                                                          (_ = 1e-6),
                                                          C < _ && C > -_ && (C = 0),
                                                          D < _ && D > -_ && (D = 0)),
                                                      (x = ((i * T) | 0) / T + "," + ((s * T) | 0) / T + "," + ((r * T) | 0) / T + "," + ((o * T) | 0) / T + "," + C + "," + D + ")"),
                                                      E && Ot ? this.t.setAttribute("transform", "matrix(" + x) : (S[kt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + x))
                                                    : (S[kt] = (P.xPercent || P.yPercent ? "translate(" + P.xPercent + "%," + P.yPercent + "%) matrix(" : "matrix(") + R + ",0,0," + A + "," + C + "," + D + ")"));
                                            if ((d && ((_ = 1e-4), R < _ && R > -_ && (R = M = 2e-5), A < _ && A > -_ && (A = M = 2e-5), !N || P.z || P.rotationX || P.rotationY || (N = 0)), O || B))
                                                (O *= I),
                                                    (g = i = Math.cos(O)),
                                                    (v = s = Math.sin(O)),
                                                    B &&
                                                        ...
                                                        (v = Math.sin(O)),
                                                        "simple" === P.skewType &&
                                                            ((e = Math.tan((B - L) * I)), (e = Math.sqrt(1 + e * e)), (g *= e), (v *= e), P.skewY && ((e = Math.tan(L * I)), (e = Math.sqrt(1 + e * e)), (i *= e), (s *= e)))),
                                                    (r = -v),
                                                    (o = g);
                                            else {
                                                if (!(k || j || 1 !== M || N || E))
                                            ...
                                            (c = 1),
                                                ...
                                                (b = "0"),
                                                (O = k * I),
                                                O && ((g = Math.cos(O)), (v = Math.sin(O)), (l = -v), (h = p * -v), (n = i * v), (a = s * v), (c = g), (p *= g), (i *= g), (s *= g)),
                                                (O = j * I),
                                                O &&
                                                    ((g = Math.cos(O)),
                                                    (v = Math.sin(O)),
                                                ...
                                                (m || E) &&
                                                    ...
                                                    E && ((C += P.xOrigin - (P.xOrigin * i + P.yOrigin * r) + P.xOffset), (D += P.yOrigin - (P.xOrigin * s + P.yOrigin * o) + P.yOffset)),
                                                    C < _ && C > -_ && (C = b),
                                                    D < _ && D > -_ && (D = b),
                                                    F < _ && F > -_ && (F = 0)),
                                                ...
                                                j || k || 1 !== M
                                                    ? ((x += $ + (u < _ && u > -_ ? b : u) + $ + (f < _ && f > -_ ? b : f) + $ + (n < _ && n > -_ ? b : n)),
                                                      (x += $ + (a < _ && a > -_ ? b : a) + $ + (c < _ && c > -_ ? b : c) + $ + (p < _ && p > -_ ? b : p) + $))
                                                    : (x += ",0,0,0,0,1,0,"),
                                                (x += C + $ + D + $ + F + $ + (N ? 1 + -F / N : 1) + ")"),
                                                (S[kt] = x);
                                        });
                                    (c = Ct.prototype),
                                            ...
                                            "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                                            {
                                                parser: function (t, e, i, r, n, o, l) {
                                                    ...
                                                    if (((r._transform = k), R && "string" == typeof R && kt))
                                                        (f = U.style),
                                                            ...
                                                            k.svg &&
                                                                ...
                                                                (_ || y) && ((x = Ut(U, !0)), (h.x -= _ - (_ * x[0] + y * x[2])), (h.y -= y - (_ * x[1] + y * x[3])))),
                                                        ...
                                                        "string" == typeof S.x && S.x.indexOf("%") !== -1 && ((h.x = 0), (h.xPercent = ct(S.x, k.xPercent))),
                                                            "string" == typeof S.y && S.y.indexOf("%") !== -1 && ((h.y = 0), (h.yPercent = ct(S.y, k.yPercent))),
                                                            ...
                                                            Mt &&
                                                                ((h.rotationX = ht("rotationX" in S ? S.rotationX : "shortRotationX" in S ? S.shortRotationX + "_short" : k.rotationX || 0, k.rotationX, "rotationX", O)),
                                                    ...
                                                    for (
                                                        ...
                                                        ($ = jt[P]),
                                                            (R = h[$] - k[$]),
                                                            (R > T || R < -T || null != S[$] || null != z[$]) && ((d = !0), (n = new xt(k, $, k[$], R, n)), $ in O && (n.e = O[$]), (n.xs0 = 0), (n.plugin = o), r._overwriteProps.push(n.n));
                                                    return (
                                                        (R = S.transformOrigin),
                                                        k.svg &&
                                                            (R || S.svgOrigin) &&
                                                            ...
                                                            (_ === k.xOffset && y === k.yOffset) || ((n = $t(k, "xOffset", b ? _ : k.xOffset, k.xOffset, n, j)), (n = $t(k, "yOffset", b ? y : k.yOffset, k.yOffset, n, j))),
                                                            (R = "0px 0px")),
                                                        (R || (Mt && p && k.zOrigin)) &&
                                                            (kt
                                                                ? ((d = !0),
                                        ...
                                        Pt("boxShadow", { defaultValue: "0px 0px 0px 0px #999", prefix: !0, color: !0, multi: !0, keyword: "inset" }),
                                        Pt("borderRadius", {
                                            defaultValue: "0px",
                                            parser: function (t, e, i, r, o, a) {
                                                ...
                                                for (_ = parseFloat(t.offsetWidth), g = parseFloat(t.offsetHeight), l = e.split(" "), u = 0; u < T.length; u++)
                                                    this.p.indexOf("border") && (T[u] = Q(T[u])),
                                                        ...
                                                        (x = "=" === p.charAt(1)),
                                                        x
                                                            ? ((m = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (m *= parseFloat(p)), (v = p.substr((m + "").length - (m < 0 ? 1 : 0)) || ""))
                                                        ...
                                                        v !== y &&
                                                            ...
                                                            "%" === v
                                                                ? ((f = ($ / _) * 100 + "%"), (h = (b / g) * 100 + "%"))
                                                                : "em" === v
                                                                ? ((w = et(t, "borderLeft", 1, "em")), (f = $ / w + "em"), (h = b / w + "em"))
                                                                : ((f = $ + "px"), (h = b + "px")),
                                        ...
                                        Pt("backgroundPosition", {
                                            ...
                                            parser: function (t, e, i, r, n, o) {
                                                var a,
                                                    ...
                                                    d = s || J(t, null),
                                                    m = this.format(
                                                        (d ? (_ ? d.getPropertyValue(p + "-x") + " " + d.getPropertyValue(p + "-y") : d.getPropertyValue(p)) : t.currentStyle.backgroundPositionX + " " + t.currentStyle.backgroundPositionY) ||
                                                            "0 0"
                                                    ),
                                                    g = this.format(e);
                                                if ((m.indexOf("%") !== -1) != (g.indexOf("%") !== -1) && g.split(",").length < 2 && ((f = tt(t, "backgroundImage").replace(R, "")), f && "none" !== f)) {
                                                    for (a = m.split(" "), l = g.split(" "), Y.setAttribute("src", f), u = 2; --u > -1; )
                                                        (m = a[u]),
                                                            (c = m.indexOf("%") !== -1),
                                                            c !== (l[u].indexOf("%") !== -1) &&
                                                                ((h = 0 === u ? t.offsetWidth - Y.width : t.offsetHeight - Y.height), (a[u] = c ? (parseFloat(m) / 100) * h + "px" : (parseFloat(m) / h) * 100 + "%"));
                                                    m = a.join(" ");
                                                }
                                        ...
                                        Pt("clip", {
                                            ...
                                            parser: function (t, e, i, r, n, o) {
                                                ...
                                                return (
                                                    _ < 9
                                                        ? ((l = t.currentStyle), (u = _ < 8 ? " " : ","), (a = "rect(" + l.clipTop + u + l.clipRight + u + l.clipBottom + u + l.clipLeft + ")"), (e = this.format(e).split(",").join(u)))
                                        ...
                                        Pt("borderWidth", { parser: vt("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth") }),
                                            ...
                                            return (
                                                ...
                                                W
                                                    ...
                                                    : ((n = new xt(l, "opacity", 100 * a, 100 * (e - a), n)),
                                                      ...
                                                      (n.setRatio = Wt)),
                                                u &&
                                                    ((n = new xt(l, "visibility", 0, 0, n, -1, null, !1, 0, 0 !== a ? "inherit" : "hidden", 0 === e ? "hidden" : "inherit")),
                                                    (n.xs0 = "inherit"),
                                    ...
                                    var Kt = function (t) {
                                        if ((1 === t || 0 === t) && this.data._totalTime === this.data._totalDuration && "isFromStart" !== this.data.data) {
                                            ...
                                            else for (e = this.e.split(" ").join("").split(","), r = e.length; --r > -1; ) (i = e[r]), u[i] && (u[i].parse === a ? (n = !0) : (i = "transformOrigin" === i ? At : u[i].p)), Vt(o, i);
                                    ...
                                    (c = a.prototype),
                                        ...
                                        (c._onInitTween = function (t, e, i, l) {
                                            ...
                                            var c,
                                                ...
                                                S = t.style;
                                            if (
                                                (f && "" === S.zIndex && ((c = tt(t, "zIndex", s)), ("auto" !== c && "" !== c) || this._addLazySet(S, "zIndex", 0)),
                                                "string" == typeof e &&
                                                    ((y = S.cssText), (c = rt(t, s)), (S.cssText = y + ";" + e), (c = nt(t, c, rt(t)).difs), !W && P.test(e) && (c.opacity = parseFloat(RegExp.$1)), (e = c), (S.cssText = y)),
                                                ...
                                                for (
                                                    T = 3 === this._transformType,
                                                        kt
                                                            ? p &&
                                                              ((f = !0),
                                                              "" === S.zIndex && ((b = tt(t, "zIndex", s)), ("auto" !== b && "" !== b) || this._addLazySet(S, "zIndex", 0)),
                                                              m && this._addLazySet(S, "WebkitBackfaceVisibility", this._vars.WebkitBackfaceVisibility || (T ? "visible" : "hidden")))
                                                            : (S.zoom = 1),
                                                        _ = d;
                                                    _ && _._next;
                                            ...
                                            for (o in e)
                                                (p = e[o]),
                                                    ...
                                                    a
                                                        ...
                                                        : ((f = tt(t, o, s) + ""),
                                                          (_ = "string" == typeof p),
                                                          "color" === o || "fill" === o || "stroke" === o || o.indexOf("Color") !== -1 || (_ && O.test(p))
                                                              ? (_ || ((p = dt(p)), (p = (p.length > 3 ? "rgba(" : "rgb(") + p.join(",") + ")")), (i = bt(x, o, f, p, !0, "transparent", i, 0, r)))
                                                              : _ && E.test(p)
                                                              ...
                                                              : ((l = parseFloat(f)),
                                                                ...
                                                                ("" !== f && "auto" !== f) ||
                                                                    ("width" === o || "height" === o
                                                                        ...
                                                                        : ((l = "opacity" !== o ? 0 : 1), (d = ""))),
                                                                (y = _ && "=" === p.charAt(1)),
                                                                y ? ((c = parseInt(p.charAt(0) + "1", 10)), (p = p.substr(2)), (c *= parseFloat(p)), (m = p.replace(w, ""))) : ((c = parseFloat(p)), (m = _ ? p.replace(w, "") : "")),
                                                                "" === m && (m = o in n ? n[o] : d),
                                                                ...
                                                                d !== m &&
                                                                    ...
                                                                    ((l = et(t, o, l, d)),
                                                                    "%" === m
                                                                        ? ((l /= et(t, o, 100, "%") / 100), e.strictUnits !== !0 && (f = l + "%"))
                                                                ...
                                                                (!l && 0 !== l) || (!c && 0 !== c)
                                                                    ? void 0 !== x[o] && (p || (p + "" != "NaN" && null != p))
                                                                        ? ((i = new xt(x, o, c || l || 0, 0, i, -1, o, !1, 0, f, p)), (i.xs0 = "none" !== p || ("display" !== o && o.indexOf("Style") === -1) ? p : f))
                                                                        : Z("invalid " + o + " tween value: " + e[o])
                                                                    : ((i = new xt(x, o, l, c - l, i, 0, o, h !== !1 && ("px" === m || "zIndex" === o), 0, f, p)), (i.xs0 = m)))),
                                    ...
                                    var Qt = function (t, e, i) {
                                        ...
                                        else for (r = t.childNodes, n = r.length; --n > -1; ) (s = r[n]), (o = s.type), s.style && (e.push(rt(s)), i && i.push(s)), (1 !== o && 9 !== o && 11 !== o) || !s.childNodes.length || Qt(s, e, i);
                                    };
                                    return (
                                ...
                                init: function (t, e, i, r) {
                                    ...
                                    for (n in e)
                                        "useRadians" !== n &&
                                            ...
                                            u.length &&
                                                ((s = u.join("_")),
                                                s.indexOf("short") !== -1 && ((l %= c), l !== l % (c / 2) && (l = l < 0 ? l + c : l - c)),
                        ...
                        (function (t, i) {
                            ...
                            if (!s.TweenLite) {
                                        ...
                                        (this.check = function (c) {
                                            ...
                                            if (0 === x && a) {
                                                if (((p = ("com.greensock." + n).split(".")), (d = p.pop()), (m = h(p.join("."))[d] = this.gsClass = a.apply(a, u)), l))
                                                    if (((s[d] = r[d] = m), (_ = "undefined" != typeof e && e.exports), !_ && "function" == typeof define && define.amd))
                                ...
                                for (
                                    ...
                                    (l = o[a] + ",Power" + a), T(new b(null, null, 1, a), l, "easeOut", !0), T(new b(null, null, 2, a), l, "easeIn" + (0 === a ? ",easeNone" : "")), T(new b(null, null, 3, a), l, "easeInOut");
                                    ...
                                    var i,
                                        ...
                                        v = function (t) {
                                            ...
                                            u > d && (h += u - _),
                                                ...
                                                (l.time = (k - h) / 1e3),
                                                (e = l.time - a),
                                                (!i || e > 0 || t === !0) && (l.frame++, (a += e + (e >= o ? 0.004 : o - e)), (n = !0)),
                                                t !== !0 && (s = r(v)),
                                                n && l.dispatchEvent(g);
                                        };
                                    P.call(l),
                                ...
                                A(),
                                    ...
                                    (l.eventCallback = function (t, e, i, r) {
                                        if ("on" === (t || "").substr(0, 2)) {
                                            ...
                                            null == e ? delete n[t] : ((n[t] = e), (n[t + "Params"] = _(i) && i.join("").indexOf("{self}") !== -1 ? this._swapSelfInParams(i) : i), (n[t + "Scope"] = r)),
                                                        ...
                                                        s
                                                            ? "string" != typeof s
                                                                ? s.length && s !== t && s[0] && (s[0] === t || (s[0].nodeType && s[0].style && !s.nodeType))
                                                                    ...
                                                                    : ((this._siblings[n] = Q(s, this, !1)), 1 === l && this._siblings[n].length > 1 && tt(s, this, null, 1, this._siblings[n]))
                                        ...
                                        if (
                                            (("number" != typeof f || ("number" != typeof r && !p)) &&
                                                (o || isNaN(f) || (!p && isNaN(r)) || "boolean" == typeof f || "boolean" == typeof r
                                                    ? ((d.fp = o), (u = L(f, p ? d.s + d.c : r, a || C.defaultStringFilter, d)), (d = { t: u, p: "setRatio", s: 0, c: 1, f: 2, pg: 0, n: n || e, pr: 0, m: 0 }))
                                ...
                                var Q = function (t, e, i) {
                                        var r,
                                            n,
                                            s = t._gsTweenID;
                                        if ((Y[s || (t._gsTweenID = s = "t" + G++)] || (Y[s] = { target: t, tweens: [] }), e && ((r = Y[s].tweens), (r[(n = r.length)] = e), i))) for (; --n > -1; ) r[n] === e && r.splice(n, 1);
                                        return Y[s].tweens;
                                    },
                                    J = function (t, e, i, r) {
                                        var n,
                                ...
                                (l._init = function () {
                                    ...
                                    if (
                                        ((this._ease = c = c ? (c instanceof b ? c : "function" == typeof c ? new b(c, o.easeParams) : w[c] || C.defaultEase) : C.defaultEase),
                                    ...
                                    (l._initProps = function (e, i, r, n, s) {
                                        ...
                                        for (o in this.vars)
                                            if (((h = this.vars[o]), q[o])) h && (h instanceof Array || (h.push && _(h))) && h.join("").indexOf("{self}") !== -1 && (this.vars[o] = h = this._swapSelfInParams(h, this));
                                                ...
                                                for (this._firstPT = c = { _next: this._firstPT, t: u, p: "setRatio", s: 0, c: 1, f: 1, n: o, pg: 1, pr: u._priority, m: 0 }, a = u._overwriteProps.length; --a > -1; )
                                        ...
                                        if (t >= l - 1e-7 && t >= 0)
                                            (this._totalTime = this._time = l),
                                                ...
                                                0 === l &&
                                                    (this._initted || !this.vars.lazy || i) &&
                                                    (this._startTime === this._timeline._duration && (t = 0),
                                                    (u < 0 || (t <= 0 && t >= -1e-7) || (u === p && "isPause" !== this.data)) && u !== t && ((i = !0), u > p && (n = "onReverseComplete")),
                                            ...
                                            (this._totalTime = this._time = 0),
                                                ...
                                                t < 0 &&
                                                    ((this._active = !1),
                                                    0 === l && (this._initted || !this.vars.lazy || i) && (u >= 0 && (u !== p || "isPause" !== this.data) && (i = !0), (this._rawPrevTime = o = !e || t || u === t ? t : p))),
                                                this._initted || (i = !0);
                                            ...
                                            (1 === h || (3 === h && c >= 0.5)) && (c = 1 - c),
                                                ...
                                                1 === h ? (this.ratio = 1 - c) : 2 === h ? (this.ratio = c) : t / l < 0.5 ? (this.ratio = c / 2) : (this.ratio = 1 - c / 2);
                                        } else this.ratio = this._ease.getRatio(t / l);
                                        if (this._time !== a || i) {
                                            if (!this._initted) {
                                                if ((this._init(), !this._initted || this._gc)) return;
                                                if (!i && this._firstPT && ((this.vars.lazy !== !1 && this._duration) || (this.vars.lazy && !this._duration)))
                                                    return (this._time = this._totalTime = a), (this._rawPrevTime = u), E.push(this), void (this._lazy = [t, e]);
                                            ...
                                            for (
                                                ...
                                                s.f ? s.t[s.p](s.c * this.ratio + s.s) : (s.t[s.p] = s.c * this.ratio + s.s), (s = s._next);
                                            this._onUpdate && (t < 0 && this._startAt && t !== -1e-4 && this._startAt.render(t, e, i), e || ((this._time !== a || r || i) && this._callback("onUpdate"))),
                                                n &&
                                                    ((this._gc && !i) ||
                                    ...
                                    (l._kill = function (t, e, i) {
                                        ...
                                        if ((_(e) || D(e)) && "number" != typeof e[0]) for (r = e.length; --r > -1; ) this._kill(t, e[r], i) && (l = !0);
                                        else {
                                            if (this._targets) {
                                                ...
                                                for (s in u)
                                                    (o = a[s]) &&
                                                        ...
                                                        (o.pg && 0 !== o.t._overwriteProps.length) ||
                                                            (o._prev ? (o._prev._next = o._next) : o === this._firstPT && (this._firstPT = o._next), o._next && (o._next._prev = o._prev), (o._next = o._prev = null)),
                                                        delete a[s]),
                                                        c && (n[s] = 1);
                                    ...
                                    (l.invalidate = function () {
                                        return (
                                            ...
                                            this.vars.immediateRender && ((this._time = -p), this.render(Math.min(0, -this._delay))),
                                            this
                                        );
                                    }),
                                    (l._enabled = function (t, e) {
                                    ...
                                    (C.delayedCall = function (t, e, i, r, n) {
                                        return new C(e, 0, { delay: t, onComplete: e, onCompleteParams: i, callbackScope: r, onReverseComplete: e, onReverseCompleteParams: i, immediateRender: !1, lazy: !1, useFrames: n, overwrite: 0 });
                                    }),
                                    (C.set = function (t, e) {
                                        return new C(t, 0, e);
                                    }),
                                    (C.getTweensOf = function (t, e) {
                                        ...
                                        } else for (r = Q(t).concat(), i = r.length; --i > -1; ) (r[i]._gc || (e && !r[i].isActive())) && r.splice(i, 1);
                                        return r;
                                    }),
        ...
        207: [
            function (t, e, i) {
                ...
                function n() {
                    (0, y["default"])([ // ANNA Hintergrundbilder
                        ...
                        (O = t.textureRainFg.img),
                            ...
                            (A = t.textureRainBg.img),
                            (M = t.textureRainBg.img),
                            (k = t.textureRainBg.img),
                            (R = t.textureRainBg.img),
                            (C = t.textureRainBg.img),
                            (D = t.textureRainBg.img),
                            (F = t.textureRainBg.img),
                            (E = t.textureRainBg.img),
                            (I = t.dropColor.img),
                            (N = t.dropAlpha.img),
                            s();
                    });
                ...
                function s() {
                    W = document.querySelector("#container"); //ANNA set canvas
                    ...
                    (W.width = window.innerWidth * t),
                        ...
                        (G = new g["default"](W.width, W.height, t, N, I, { trailRate: 1, trailScaleRange: [0.2, 0.45], collisionRadius: 0.45, dropletsCleaningRadiusMultiplier: 0.28 })),
                        (z = (0, $["default"])(Y.width, Y.height)),
                        (L = z.getContext("2d")),
                        (B = (0, $["default"])(U.width, U.height)),
                        (X = B.getContext("2d")),
                        p(O, j),
                        (q = new m["default"](W, G.canvas, z, B, null, { brightness: 1.04, alphaMultiply: 6, alphaSubtract: 3 })),
                        o();
                }
                function o() {
                    a(), u(), l();
                ...
                function p(t, e) {
                    ...
                    (L.globalAlpha = i), L.drawImage(t, 0, 0, Y.width, Y.height), (X.globalAlpha = i), X.drawImage(e, 0, 0, U.width, U.height); //ANNA
                }
                t("core-js");
                ...
                (s.prototype = Object.defineProperties(
                    {
                        ...
                        init: function () {
                            ...
                            (this.programWater = t.program),
                                ...
                                (this.textures = [
                                    { name: "textureShine", img: null == this.imageShine ? (0, h["default"])(2, 2) : this.imageShine },
                ...
                (s.prototype = Object.defineProperties(
                    {
                        ...
                        init: function () {
                            (this.canvas = (0, c["default"])(this.width, this.height)),
                                ...
                                (this.droplets = (0, c["default"])(this.width * this.dropletsPixelDensity, this.height * this.dropletsPixelDensity)),
                        ...
                        drawDroplet: function (t, e, i) {
                            this.drawDrop(this.dropletsCtx, Object.assign(Object.create(p), { x: t * this.dropletsPixelDensity, y: e * this.dropletsPixelDensity, r: i * this.dropletsPixelDensity }));
                        },
                        ...
                        updateRain: function (t) {
                            ...
                            if (this.options.raining)
                                for (var i = this.options.rainLimit * t * this.areaMultiplier, r = 0; (0, h.chance)(this.options.rainChance * t * this.areaMultiplier) && r < i; ) {
                                    r++;
                        ...
                        updateDrops: function (t) {
                            ...
                            (i = i.concat(r)),
                                ...
                                this.drops.forEach(function (e, r) {
                                    ...
                                    if (!e.killed) {
                                        if (
                                            ((0, h.chance)((e.r - this.options.minR * this.options.dropFallMultiplier) * (0.1 / this.deltaR) * t) && (e.momentum += (0, h.random)((e.r / this.options.maxR) * 4)),
                                            this.options.autoShrink && e.r <= this.options.minR && (0, h.chance)(0.05 * t) && (e.shrink += 0.01),
                                            (e.r -= e.shrink * t),
                                            e.r <= 0 && (e.killed = !0),
                                            this.options.raining && ((e.lastSpawn += e.momentum * t * this.options.trailRate), e.lastSpawn > e.nextSpawn))
                                        ) {
                                            var o = this.createDrop({ x: e.x + 0.1 * (0, h.random)(-e.r, e.r), y: e.y - 0.01 * e.r, r: e.r * h.random.apply(void 0, n(this.options.trailScaleRange)), spreadY: 0.1 * e.momentum, parent: e });
                                            null != o &&
                                                (i.push(o),
                                                (e.r *= Math.pow(0.97, t)),
                                                (e.lastSpawn = 0),
                                                (e.nextSpawn = (0, h.random)(this.options.minR, this.options.maxR) - 2 * e.momentum * this.options.trailRate + (this.options.maxR - e.r)));
                                        }
                                        ...
                                        (e.isNew = !1),
                                            ...
                                            e.killed || (i.push(e), a && this.options.dropletsRate > 0 && this.clearDroplets(e.x, e.y, e.r * this.options.dropletsCleaningRadiusMultiplier), this.drawDrop(this.ctx, e));
                                    }
                                }, this),
                                (this.drops = i);
                        },
